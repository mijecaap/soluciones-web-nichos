  ...
  return (
    <>
      <HeroSection
        ...
        subtitle="Creamos páginas web que posicionan tu negocio en Google. Desde soluciones económicas para emprendedores hasta sistemas avanzados para negocios establecidos en Lima y todo el Perú. Más visibilidad, más clientes, más ingresos."
        ctaText="Ver Soluciones Premium"
        ctaLink="#nichos"
        secondaryCtaText="Ver Soluciones Económicas"
