...
export default function TerminosPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative pt-32 pb-12 bg-[#09090B] overflow-hidden">
        <div className="absolute top-1/3 right-1/3 w-72 h-72 rounded-full bg-violet-600/10 blur-[120px]" />
      ...
      <section className="py-16 bg-[#09090B]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-invert max-w-none">
            ...
            <ul className="list-disc pl-6 text-slate-400 mb-8 space-y-2">
            ...
            <p className="text-slate-400 mb-6">El cliente se compromete a:</p>
            <ul className="list-disc pl-6 text-slate-400 mb-8 space-y-2">
            ...
            <ul className="list-none text-slate-400 mb-8 space-y-2">
              <li>
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] p-6 rounded-xl mt-8">
