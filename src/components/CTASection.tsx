          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {secondaryCta && (
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white/10 transition-colors"
              >
                {secondaryCta.text}
              </Link>
            )}
